      ...
      <div className="mx-auto max-w-[1600px] px-3 py-3 sm:px-5 lg:px-7 lg:py-6">
        ...
        <div className="mt-4 grid gap-4 lg:grid-cols-[232px_minmax(0,1fr)]">
          ...
          <div className="min-w-0">
            ...
            {activeView === "credits" && <><CreditPlanningSummary status={creditPlanStatus} /><CreditsView credits={credits} goals={data.goals} showEditor={showGoalEditor} setShowEditor={setShowGoalEditor} onGoalChange={updateGoals} /><CreditRecognitionMap courses={data.courses} /></>}
